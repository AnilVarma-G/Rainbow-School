...
const Facilities = () => {
    const items = [
        {
            header: "Transport",
            imageSrc: "/transpaort.jpg", // Replace with actual image path
        ...
        },
        {
            ...
            imageSrc: "/cccamera.jpg", // Replace with actual image path
        ...
        },
        {
            ...
            imageSrc: "/classroom.jpg", // Replace with actual image path
        ...
        },
        {
            ...
            imageSrc: "/kids.jpg", // Replace with actual image path
        ...
        },
        {
            ...
            imageSrc: "/caring.jpg", // Replace with actual image path
        ...
        },
        {
            ...
            imageSrc: "/gates.jpg", // Replace with actual image path
    ...
    return (
        ...
        <h1 className="text-3xl font-bold mb-8 text-yellow-300">Our Facilities</h1>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {items.map((item, index) => (
                <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                    <h2 className="text-xl font-semibold mb-2 p-2">{item.header}</h2>
                    <img
                        src={item.imageSrc}
                        alt={item.header}
